function bmodel = fastBoot(data,labels,binVals,bins,params)

% Find the weak rules to be used to compute the fastBoot distances.

numIters = params.iter;
...
%      wkRule.dir(ndx) = -wkRule.dir(ndx);
  ...
  if mod(itt,10)==0,
    ...
    fprintf('FastBoot: %d%% done. Time Remaining:%d\n',...
